...
public class SubColumnEncodingTest {
  ...
  public void testSubColumnIntRoundTrip() throws Exception {
    ...
    Encoder encoder =
        TSEncodingBuilder.getEncodingBuilder(TSEncoding.SUBCOLUMN).getEncoder(TSDataType.INT32);
  ...
  public void testSubColumnLongRoundTrip() throws Exception {
    ...
    Encoder encoder =
        TSEncodingBuilder.getEncodingBuilder(TSEncoding.SUBCOLUMN).getEncoder(TSDataType.INT64);
    ByteArrayOutputStream out = new ByteArrayOutputStream();
