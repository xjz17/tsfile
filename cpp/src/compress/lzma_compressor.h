 ...
 * under the License.
 */
#ifndef COMPRESS_LZMA_COMPRESSOR_H
#define COMPRESS_LZMA_COMPRESSOR_H
...
class LZMACompressor : public Compressor {
   public:
    LZMACompressor() : compressed_buf_(nullptr), uncompressed_buf_(nullptr) {}
    ~LZMACompressor() {}
...
#endif  // COMPRESS_LZMA_COMPRESSOR_H
