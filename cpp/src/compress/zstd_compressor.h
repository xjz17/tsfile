 ...
 * under the License.
 */
#ifndef COMPRESS_ZSTD_COMPRESSOR_H
#define COMPRESS_ZSTD_COMPRESSOR_H
...
class ZSTDCompressor : public Compressor {
   public:
    ZSTDCompressor() : compressed_buf_(nullptr), uncompressed_buf_(nullptr) {}
    ~ZSTDCompressor() {}
...
#endif  // COMPRESS_ZSTD_COMPRESSOR_H
